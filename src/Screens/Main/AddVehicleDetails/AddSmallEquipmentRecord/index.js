...
const AddSmallEquipmentRecord = ({route}) => {
  ...
  const handleSubmitForm = async values => {
    ...
    LOG('Small Record Add Success:', response);
              ...
              <>
                ...
                {editParams ? (
                  ...
                  <ModalComponent
                    ...
                    title="Record Added"
                    message="Do you want to add another small equipment record?"
                    doublemodal
                    buttonText1="No"
                    buttonText="Yes"
                    onButtonPress={() => {
...
export default AddSmallEquipmentRecord;
